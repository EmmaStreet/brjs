...
public class AliasModelTest extends SpecTest {
	...
	@Test
	public void aliasOverridesAreRetrievableViaTheModel() throws Exception {
	...
	@Test
	public void aliasOverridesMustDefineANonEmptyClassName() throws Exception {
	...
	public void theNonGroupAliasIsUsedByDefault() throws Exception {
		given(bladeAliasDefinitionsFile).hasAlias("appns.bs.b1.the-alias", "Class1")
			.and(bladeAliasDefinitionsFile).hasGroupAlias("g1", "appns.bs.b1.the-alias", "Class2");
		then(aspect).hasAlias("appns.bs.b1.the-alias", "Class1");
	}
	
	@Test
	public void settingAGroupChangesTheAliasesThatAreUsed() throws Exception {
		given(bladeAliasDefinitionsFile).hasGroupAlias("g1", "appns.bs.b1.the-alias", "Class1")
			.and(bladeAliasDefinitionsFile).hasGroupAlias("g2", "appns.bs.b1.the-alias", "Class2")
	...
	public void groupAliasesCanOverrideNonGroupAliases() throws Exception {
		given(bladeAliasDefinitionsFile).hasAlias("appns.bs.b1.the-alias", "Class1")
			.and(bladeAliasDefinitionsFile).hasGroupAlias("g1", "appns.bs.b1.the-alias", "Class2")
			.and(bladeAliasDefinitionsFile).hasGroupAlias("g2", "appns.bs.b1.the-alias", "Class3")
			.and(aspectAliasesFile).usesGroups("g1");
		then(aspect).hasAlias("appns.bs.b1.the-alias", "Class2");
	}
	...
	public void groupsCanContainMultipleAliases() throws Exception {
		given(bladeAliasDefinitionsFile).hasGroupAlias("g1", "alias1", "Class1")
			.and(bladeAliasDefinitionsFile).hasGroupAlias("g1", "alias2", "Class2")
			.and(aspectAliasesFile).usesGroups("g1");
	...
	public void groupAliasesAreNotNamespaced() throws Exception {
		given(bladeAliasDefinitionsFile).hasGroupAlias("g1", "the-alias", "Class1")
			.and(aspectAliasesFile).usesGroups("g1");
		then(aspect).hasAlias("the-alias", "Class1");
	}
	...
	public void usingGroupsCanLeadToAmbiguityEvenWhenASingleGroupIsUsed() throws Exception {
		given(bladeAliasDefinitionsFile).hasGroupAlias("g1", "appns.bs.b1.the-alias", "Class1")
			.and(bladesetAliasDefinitionsFile).hasGroupAlias("g1", "appns.bs.b1.the-alias", "Class2")
			.and(aspectAliasesFile).usesGroups("g1");
		when(aspect).retrievesAlias("appns.bs.b1.the-alias");
		then(exceptions).verifyException(AmbiguousAliasException.class, "appns.bs.b1.the-alias", aspectAliasesFile.getUnderlyingFile().getPath());
	}
	...
	public void settingMultipleGroupsChangesTheAliasesThatAreUsed() throws Exception {
		given(bladeAliasDefinitionsFile).hasGroupAlias("g1", "appns.bs.b1.alias1", "Class1")
			.and(bladeAliasDefinitionsFile).hasGroupAlias("g2", "appns.bs.b1.alias2", "Class2")
			.and(aspectAliasesFile).usesGroups("g1", "g2");
